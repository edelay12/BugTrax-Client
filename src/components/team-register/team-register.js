  ...
  return (
    <form className="Team-register-form" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="Tr-col">
        <label htmlFor="Team-register-c" className="Team-register-l">
          Company*
        </label>
        <input
          required
          className="Team-register-c bt-input"
          name="company"
          type="text"
          ref={register}
        />
      ...
      <div className="Tr-col">
        <label htmlFor="Team-register-c2" className="Team-register-l">
          Team name*
        </label>
        <input
          className="Team-register-c bt-input"
      ...
      <div className="Tr-col">
        <label className="Team-register-l" htmlFor="team_passwordRepeat">
          Re-enter password*
        </label>
        <input
          className="Team-register-c bt-input"
          name="team_passwordRepeat"
          type="password"
          required
          ref={register({
            validate: {
      ...
      {errors.team_passwordRepeat && (
        <p className="red">{errors.team_passwordRepeat.message}</p>
      )}
      <div className="Tr-row">
        <input
          className="Team-register-check bt-input"
          name="team_admin"
          type="checkbox"
          ref={register}
        />
        <label className="Team-register-l" htmlFor="team_admin">
          {" "}
          Are you this team's administrator?
        </label>
      </div>

      <button className="Team-register-submit-b Radial-button" type="submit">
        Create team
      </button>
    </form>
  );
