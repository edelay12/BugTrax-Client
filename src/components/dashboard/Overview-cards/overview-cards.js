        ...
        <Link to="/dashboard/issues">
          <div className="O-card-in">
            <div className="O-card-in-left">
              ...
              <span className="O-card-number">
                {ContextMain.newIssues.length}
              </span>
            </div>
            <div className="O-card-in-right">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="O-card-icon"
                viewBox="0 0 512 512"
              >
                <path d="M368 96H144a16 16 0 010-32h224a16 16 0 010 32zM400 144H112a16 16 0 010-32h288a16 16 0 010 32zM419.13 448H92.87A44.92 44.92 0 0148 403.13V204.87A44.92 44.92 0 0192.87 160h326.26A44.92 44.92 0 01464 204.87v198.26A44.92 44.92 0 01419.13 448z"></path>
              </svg>
            </div>
          </div>
        ...
        <Link to="/dashboard/issues">
          <div className="O-card-in">
            <div className="O-card-in-left">
              ...
              <span className="O-card-number">
                {ContextMain.resolvedIssues.length}
              </span>
            </div>
            <div className="O-card-in-right">
              <svg
      ...
      <div className="O-card light-blue">
        <Link to="/dashboard/issues">
          ...
          <div className="O-card-footer">
            ...
            <span>
              {(ContextMain.activeIssues.length * percentageChange)
                .toFixed(2)}
              % this month
            </span>
          </div>
