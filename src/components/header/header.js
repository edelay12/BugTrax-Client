  ...
  return (
    <header className="Dashboard-header">
      <div className="Header-left-c">
        <span
          id={
            sidebar ? "Sidebar-toggle-mobile" : "Sidebar-toggle-mobile-closed"
          }
          onClick={() => sIsOpen(!sidebar)}
        >
          <FontAwesomeIcon icon={faAngleDoubleRight} />
        </span>
      </div>
      <div className="Team-name-c">
        <h3 className={sidebar ? "Team-name-closed" : "Team-name"}>
          {teamName}
        </h3>
      </div>
      <div className={sidebar ? "Header-right-c-closed" : "Header-right-c"}>
        <span className="Show-sif-toggle" onClick={showSif}>
        ...
        >
          ...
          />
          <FontAwesomeIcon
            className="Profile-options-toggle"
            icon={faEllipsisV}
          />
          <div
            className={dropdown ? "header-dropdown" : "header-dropdown-hidden"}
          ...
          >
            <ul className="header-dropdown-list">
              ...
              >
                <Link
                  to={`/dashboard/profile/${TokenService._getUserId(
              ...
              <li className="Header-logout-link" onClick={handleLogoutClick}>
                Logout
              </li>
            </ul>
          </div>
