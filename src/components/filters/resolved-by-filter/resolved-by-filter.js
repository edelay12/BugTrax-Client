...
export default function ResolvedByFilter({results,  filteredResults, filter, clear, setClear}){
    ...
    return (
<Select disabled={disable} className='filterSelect' onChange={e=> handleFilter(e.value)} options={options} values={value}/>
    )
}