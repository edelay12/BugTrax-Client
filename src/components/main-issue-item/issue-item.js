...
return (
    <div className='Issue-item'>
        <div className='Issue-item-left'>
            <div className={`issue-item-severity-indicator Issue-${issue.severity}`}></div>
            <span className='Issue-item-id'><b>Id:</b> {issue.id}</span>
        ...
        <div className='Issue-item-right'>
           <Link to={`/dashboard/issues/${issue.id}`}><span className='Issue-item-summary'>{issue.summary}</span></Link>
            <div className='Issue-item-right-bottom-row'>
                ...
                <span className='Issue-item-date'><FontAwesomeIcon className='fa-Te' icon={faClock} />{issue.date_updated}</span>
            </div>
        </div>
    </div>
)
