...
<label id='Issue-details-label' className='l1'>Reporter</label>
...
<span id='Issue-details-span' className='s2'><Link to={`/dashboard/profile/${issue.creator_id}`}>{issue.creator_user_name}</Link></span>
