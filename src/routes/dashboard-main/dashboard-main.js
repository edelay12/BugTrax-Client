...
import { faExclamationCircle, faChartPie, faUsers, faAngleDoubleLeft, faCaretDown } from '@fortawesome/fontawesome-free-solid';
...
/*
    ...
    return (
      ...
      <Route exact path={`${url}/issues`} render={props => <Issues teamId={teamId}/>} />
