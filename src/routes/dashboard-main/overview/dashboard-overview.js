...
import { faUsers, faHourglassHalf, faHistory, faHourglass } from '@fortawesome/fontawesome-free-solid';
...
export default class Overview extends Component {
 ...
 <section className='Overview-row'>
  ...
  <Collapsible open={true} trigger={<Trigger name='Analytics' icon={faChartBar} iconClass='analytics-icon'/>}>
  ...
  <Collapsible open={true} trigger={<Trigger name='Team' icon={faUsers} iconClass='team-icon' />}>
      <div className='Overview-issues-frame'>
      <OverviewTeamList />
        </div>
      </Collapsible>
 ...
 <section className='Overview-row'>
        ...
        <Collapsible open={true} trigger={<Trigger name='Active' icon={faHourglassHalf} iconClass='active-icon' />}>
        <div className='Overview-issues-frame'>
            <div className='O-issue'>
        <p>This is the collapsible content. It can be any element or React component you like.</p>
        </div>
      ...
      <Collapsible open={true} trigger={<Trigger name='Resolved' icon={faHourglass} iconClass='resolved-icon'/>}>
      <div className='Overview-issues-frame'>
            <div className='O-issue'>
        <p>This is the collapsible content. It can be any element or React component you like.</p>
        </div>
      ...
      <Collapsible open={true} trigger={<Trigger name='Recently modified' icon={faHistory} iconClass='modified-icon'/>}>
      <div className='Overview-issues-frame'>
            <div className='O-issue'>
        <p>This is the collapsible content. It can be any element or React component you like.</p>
        </div>
      ...
      <Collapsible open={true} trigger={<Trigger name='Timeline' icon={faHistory} iconClass='modified-icon'/>}>
      <div className='Overview-issues-frame'>
        <TimelineEvent />
        <TimelineEvent />
        <TimelineEvent />
